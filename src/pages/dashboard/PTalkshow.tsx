    ...
    return (
        <div className="p-1 w-full">
            <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
                <h1 className="text-3xl font-semibold text-gray-800">Daftar Peserta Talkshow</h1>
            </div>
                        ...
                        {paginatedData.length > 0 ? (
                            paginatedData.map((talkshow, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 border-b font-medium text-gray-800">{talkshow.name}</td>
                                    <td className="px-4 py-2 border-b">{talkshow.category}</td>
                                    <td className="px-4 py-2 border-b">{talkshow.whatsApp}</td>
                                    <td className="px-4 py-2 border-b">{talkshow.asalInstitusi}</td>
                                    <td className="px-4 py-2 border-b">{talkshow.payment}</td>
