    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (Array.isArray(response)) {
          console.log("[v0] Talkshow data (array):", response);
          setTalkshowData(response);
          setError(null);
        } else if (
          response &&
          ...
          console.log("[v0] Talkshow data (wrapped):", response.data);
          setTalkshowData(response.data);
          setError(null);
        } else {
