...
const RegisterUiUxPage: React.FC = () => {
    ...
    const handleCloseModal = () => {
        ...
        // atau
        navigate("/competition/web-design"); // Pindah ke home
    };
    // ----------------------------------------
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        data.append("jenisKeikutsertaan", "mahasiswa"); // <-- Data fix
        ...
        if (tipe === "tim") {
            ...
            data.append("anggota3", formData.anggota3);
        } else {
            // Individu
    ...
    const deskripsiFormat = `Format deskripsi: "${namaUntukBayar || (tipe === "tim" ? "[NamaTim]" : "[NamaLengkap]")
